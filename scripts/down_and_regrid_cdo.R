...
str_glue("https://esgf-data.dkrz.de/esg-search/wget?domain={dom}-22&experiment=rcp85&experiment=historical&institute=GERICS&time_frequency=mon&variable=hurs&variable=pr&variable=rsds&variable=sfcWind&variable=tas&download_structure=domain,variable") %>% 
#str_glue("https://esgf-data.dkrz.de/esg-search/wget?domain={dom}-22&experiment=rcp85&experiment=historical&institute=GERICS&time_frequency=mon&variable=rsdt&download_structure=domain,variable") %>%
